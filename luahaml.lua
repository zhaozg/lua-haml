...
local function pr (t, name, indent,conv)
  local tableList = {}
  function table_r (t, name, indent, full)
    ...
    if type(t) == "table" then
        ...
        local val = type(t)~="number" and type(t)~="boolean" and '"'..tostring(conv and conv(t) or t)..'"' or tostring(t)
...
function print_r (t, name,conv)
  print(pr(t,name, indent, conv))
end
